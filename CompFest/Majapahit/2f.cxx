...
int main(int argc, char **argv){
    ...
    REP(q){
        cin>>c>>x;
        switch(c){
            case 'A':   cout<<binary_search(v.begin(),v.end(),x)<<'\n';
                        break;
            case 'B':   cout<<distance(v.begin(),upper_bound(v.begin(),v.end(),x))<<'\n';
                        break;
            case 'C':   cin>>y;
                        cout<<distance(lower_bound(v.begin(),v.end(),x),upper_bound(v.begin(),v.end(),y))<<'\n'; break;
        }
    }       
