...
int main(int argc, char **argv){
	...
	int tabelfrekuensi[1001],m=0,vm=0,n,a;
	fill(tabelfrekuensi,tabelfrekuensi+1001,0);
	cin>>n;
	for(int i=0;i<n;++i){
		cin>>a;
		if(++tabelfrekuensi[a]>m)m=tabelfrekuensi[a],vm=a;
		else if(tabelfrekuensi[a]==m && a>vm) vm=a;
	}
	cout<<vm<<'\n';
